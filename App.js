 ...
 */
 ...
 const App: () => React$Node = () => {
  ...
  /* 
  These are hooks that define state variables so our calculator rememeber things. 
  */
 ...
 for the expressions in {}. These expressions get evaluated first, and then the value
